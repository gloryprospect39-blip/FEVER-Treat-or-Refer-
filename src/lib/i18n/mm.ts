...
export const mm = {
  ...
  assistant: {
    title: "AI အကူအညီ",
    subtitle: "ဆေးဘက်ဆိုင်ရာ မေးခွန်းများ မေးမြန်းရန် (အကြံပြုသာ)",
    open: "AI အကူအညီ ဖွင့်ရန်",
    close: "ပိတ်ရန်",
    placeholder: "မေးခွန်း ရိုက်ထည့်ပါ…",
    send: "ပို့ရန်",
    thinking: "စဉ်းစားနေသည်…",
    disclaimer:
      "AI ၏ အကြံပြုချက်များသည် ကိုးကားရန်သာဖြစ်ပြီး ဆရာဝန်၏ ဆုံးဖြတ်ချက်ကို အစားမထိုးပါ။",
    unavailable:
      "AI အကူအညီ ကို ဖွင့်ထားခြင်း မရှိသေးပါ (GEMINI_API_KEY သတ်မှတ်ပါ)။",
    error: "တောင်းဆိုမှု မအောင်မြင်ပါ။ ထပ်ကြိုးစားပါ။",
    greeting:
      "မင်္ဂလာပါ။ ဖျားနာမှု စစ်ဆေးခြင်း၊ အန္တရာယ်လက္ခဏာများ သို့မဟုတ် ကုသမှု အကြောင်း မေးမြန်းနိုင်ပါသည်။",
    contextChip: "လက်ရှိလူနာ အချက်အလက်ဖြင့် မေးရန်",
  },
