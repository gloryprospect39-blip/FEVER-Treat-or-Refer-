...
export const mm = {
  ...
  clinic: {
    ...
    stockHint:
      "နေ့စဉ် ​ဆေးခန်း စတင်ချိန် တစ်နေ့ တစ်ကြိမ် သာဖြည့်ရန် (လူနာတိုင်း ပြန်မမေးရ)",
